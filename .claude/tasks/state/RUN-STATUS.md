...
| 4-5 | ✅ done | 9 | feat/4-5-node-write-outline-script | — |
| 4-6 | 🔵 in-progress | 0 | feat/4-6-semantic-storyboard-layout-engine-core | — |
| 4-7 | ✅ done | 8 | feat/4-7-dieu-khien-run-huy-ngam-resume | Steps 1-6+8 done; Step 7 (FE) deferred to 5-8
| 4-8 | 🔵 in-progress | 0 | feat/4-8-diem-vao-co-san-kich-ban | — |
