...
| 4-7 | 🔵 in-progress | 1 | feat/4-7-dieu-khien-run-huy-ngam-resume | Step 1 done (RUNNING->CANCELLED run-status edge). See state/4-7.json decisions -- task text's "extend 1-4's matrix" actually refers to PipelineRun.status, not ProjectStatus. |
