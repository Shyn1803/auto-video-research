...
PROMPT_SEEDS: list[PromptSeed] = [
    ...
    },
    {
        ...
        "variables": ['persona', 'topic', 'ranked_summaries', 'target_duration_s', 'claims_passed'],
    },
    {
        ...
        "variables": ['persona', 'topic', 'outline_json', 'target_duration_s'],
    },
    {
